...
<body>
            ...
            <tbody>
                <%
                    if (!("0.0").equals(lat) && !("0.0").equals(lnt)) {
                        ...
                        List<wifiDTO> list = wifiDAO.getWifiList(lat, lnt);

                        if (list != null) {
                            for (data.wifiDTO wifiDTO : list) {
                %>
                    <tr>
    ...
    <script>
        ...
        let getWifi = document.getElementById("btn_nearest_wifi");
        ...
        getWifi.addEventListener("click", function (){
